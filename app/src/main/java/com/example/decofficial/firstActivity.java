...
import com.example.decofficial.databinding.ActivityFirstBinding;
...
public class firstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AppCompatButton loginBtn = (AppCompatButton) binding.loginBtn;
        final AppCompatButton registerBtn = (AppCompatButton) binding.registerBtn;
